...
namespace TYPO3\CMS\Core\Tag\Collection;
...
/**
 * Tag Collection to handle records attached to a tag
 */
class TagCollection extends AbstractRecordCollection implements EditableCollectionInterface
{
    /**
     ...
     * @var string
     */
    protected static $storageTableName = 'sys_tag';
