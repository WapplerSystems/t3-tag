...
t.items.indexOf(t.options[e].value)>-1&&(n.style.display="none"),n.firstChild.addEventListener("click",(e=>{e.preventDefault(),t.addItem(e.target.getAttribute("data-value"))})),i.append(n)}t.control.lastChild.setAttribute("disabled","disabled")})),t.on("item_add",((e,t)=>{i.querySelectorAll(`li > button[data-value="${e}"]`)[0].parentNode.style.display="none"})),t.on("item_remove",((e,t)=>{i.querySelectorAll(`[data-value="${e}"]`)[0].parentNode.style.display=""})),t.hook("instead","open",(()=>{}))})),de.define("counter",(function(e){this.require("checkbox_options")
const t=this
